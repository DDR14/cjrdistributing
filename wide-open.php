...
<html lang="<?php echo $lang; ?>">
    <head>
        ...
        <meta name="description" content="<?php echo $wide_open_desc; ?>">
        <meta name="keywords" content="<?php echo $wide_open_keyw; ?>">
        <meta name="author" content="<?php echo $author; ?>">
        <title><?php echo $wide_open_title; ?></title>
        <?php
        echo $wide_open_cano;
    ...
    <body>
        ...
        ?>
        <section class="wide-open page machine" id="wide-open">
